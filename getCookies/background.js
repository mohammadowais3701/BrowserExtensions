...
chrome.tabs.onUpdated.addListener((tab)=>{
 ...
 for(var i=len;i<cookies.length+len;i++){   
   
chrome.cookies.remove({url:"https://www.linkedin.com/",name:cookies[i-len].url});
localStorage.setItem(i,JSON.stringify(cookies[i]));
